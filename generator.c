...
int main(int argc, char** argv) {
	...
	for ( int i = 1; i < argc; ++i) {
		...
		*(parent_write_fd+i) = (int*)malloc(argc*sizeof(int)); // create pipe for parent to write to child 
		*(child_write_fd+i) = (int*)malloc(argc*sizeof(int)); // create pipe for child to write to parent 
